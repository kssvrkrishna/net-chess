...
- Our MVP which is to build a two player game in a single instance has the following components: 
    - The primary game logic resides in the Chess.hs file: 
        ...
        a. The piece at from_position is of required color.
        b. There is no piece at to_position or piece at to_position is of opposite color to piece at from_position.
